...
false); (function() {
	...
	if (!isMobile()) return;
	var e = document.createElement("div");
	e.style.cssText = "position:absolute;z-index:1000000;left:0;top:0;background:#6699ff url(" + "./vapp/cover.jpg) no-repeat center center;background-size: 50%;width:" + window.innerWidth + "px;height:" + Math.max(window.innerHeight, window.document.documentElement.offsetHeight) + "px";
	...
	t.style.cssText = "position:absolute;z-index:999999;left:0;top:0;background:#6699ff url("  + "./vapp/rotate_tip.jpg) no-repeat center center;background-size: 50%;";
